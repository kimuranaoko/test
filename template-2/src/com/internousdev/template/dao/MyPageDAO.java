...
public class MyPageDAO {
	...
	throws SQLException{
		...
		String sql="SELECT item.item_name,ubit.total_price,ubit.total_count,ubit.pay FROM user_buy_item ubit LEFT JOIN item ON ubit.item_transaction_id=item.id WHERE ubit.item_transaction_id=? AND ubit.user_master_id=? ORDER BY ubit.insert_date DESC";
