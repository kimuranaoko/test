...
//			(destinationInfoDtoList.get(0).getId())をpurchaseHistoryInfoDtoList.get(i).setDestinationIdに登録
//			宛先情報のIDを買い物履歴を購入履歴のiつめのDestinationIdにセット
		...
		if(count > 0){
			...
			if(count >0){
				...
				cartInfoDtoList = cartInfoDAO.getCartInfoDtoList(String.valueOf(session.get("login_id")));
